/*
 * File: app/controller/DataIndiacator.js
 *
...
Ext.define('lib_core.controller.DataIndiacator', {
    extend: 'Ext.app.Controller',
    alias: 'controller.dataindicator',

    onIndicatorChange: function(cfg, response, operation) {
